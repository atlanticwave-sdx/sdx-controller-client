...
class TopologyApi(object):
    ...
    def get_topologyby_grenml(self, **kwargs):  # noqa: E501
        """Get topology grenml  # noqa: E501

        Returns a single topology by grenml  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_topologyby_grenml(async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_topologyby_grenml_with_http_info(
                **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_topologyby_grenml_with_http_info(
                **kwargs
            )  # noqa: E501
            return data

    def get_topologyby_grenml_with_http_info(self, **kwargs):  # noqa: E501
        """Get topology grenml  # noqa: E501

        Returns a single topology by grenml  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_topologyby_grenml_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_topologyby_grenml" % key
                )
            params[key] = val
        del params["kwargs"]
    ...
    def topology_version_with_http_info(
        self, topology_id, **kwargs
    ):  # noqa: E501
        """Finds topology version  # noqa: E501
